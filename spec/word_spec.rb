...
describe('.Word') do
  describe('#self.add_to_lib') do
    it "adds a word the the @@all_words class object, and returns the new @@all_words class object array" do
  ...
  describe('#find_index_by_term') do
    it "takes a 'term' string and attempts to match it to one of the sotred word object's Word.term. Returns index of Word object in @@all_words" do
